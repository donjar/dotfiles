...
alias v="nvim"
alias wifi="sudo killall create_ap; sudo create_ap wlp3s0 enp0s25 perditus paradisus"
alias k="ssh ktom@188.166.177.64 -p 1729"
...
export PATH="$PATH:~/.gradle/gradle-4.1/bin"
